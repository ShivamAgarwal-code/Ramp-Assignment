...
export function App() {
  const { data: employees, loading: employeeLoading, fetchAll: fetchAllEmployees } = useEmployees();
  const { data: paginatedTransactions, loading: paginatedTransactionsLoading, fetchAll: fetchAllPaginatedTransactions } = usePaginatedTransactions();
